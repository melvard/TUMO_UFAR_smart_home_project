...
class BMP280():
	...
	def write_configuration(self):
		...
		PRES_SAMPLE = (BMP280_P_OVERSAMPLE_1 |BMP280_MODE_NORMAL)
		bus.write_byte_data(BMP280_DEFAULT_ADDRESS, BMP280_CTRL_MEAS_REG, PRES_SAMPLE)
